 ...
 * If you rename the widget, replace Deck instance to the new name
 *
 */

var IpWidget_Deck = function () {
    ...
    var openPopup = function () {
        ...
        $('#ipDeckPopup').remove(); //remove any existing popup. This could happen if other widget is in management state right now.

        //get popup HTML using AJAX. See AdminController.php widgetPopupHtml function
        var data = {
            aa: 'Deck.widgetPopupHtml',
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var $popup = $('#ipDeckPopup .ipsModal');
                $popup.modal();
